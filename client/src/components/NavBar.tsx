...
export function NavBar() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 p-4 z-50 pointer-events-none flex justify-center">
      <nav className="glass-panel pointer-events-auto rounded-full px-6 py-3 flex items-center gap-8 shadow-2xl bg-white/80 backdrop-blur-md border border-gray-100">
        {navItems.map((item) => {
